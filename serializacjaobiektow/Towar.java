...
public class Towar implements Serializable
{
    ...
    public String toString()
    {
        ...
        return this.cena+" z³; nazwa: "+this.nazwa+" "+kalendarz.get(Calendar.YEAR)+" rok "+(kalendarz.get(Calendar.MONTH)+1)+" m "+kalendarz.get(Calendar.DAY_OF_MONTH)+" dz ";
    }
    ...
    private void readObject(ObjectInputStream inS) throws IOException, ClassNotFoundException
    {
        ...
        if (haslo != null)
         if (!haslo.equals("tajne"))
            throw new IOException("Dane s¹ nieprawid³owe");
